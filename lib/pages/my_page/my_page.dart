          ...
          children: [
            ...
            Row( //여행, 미션, 친구 수
              ...
              children: [
                ...
                SizedBox(width: 33),
                _StateItem("15", "미션"),
                // SizedBox(width: 33),       //이거 없애자고 한것 같아서 일단 주석처리
                // _StateItem("15", "친구")
              ],
            ),
            SizedBox(height: 30,),
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        CupertinoPageRoute(
                            builder: (context) => Mission_Page()  //일단 없앨 수도 있어서 아무페이지나 연결해 놓음
                        )
                    );
                  },
...
Widget _menuItem(BuildContext context, IconData icon, String menu, Widget page) {  //각종 다른 기능을 가지고 있는 다른 페이지로 넘어가는거
  return Padding( //  버튼 주변에 여백 추가
    padding: EdgeInsets.symmetric(vertical: 1), // 위아래 여백 4px 설정
    child: SizedBox(
      width: 300, // 버튼 너비
      child: TextButton(
        onPressed: () {
        ...
        style: TextButton.styleFrom(
          tapTargetSize: MaterialTapTargetSize.shrinkWrap, // 터치 크기 최소화
